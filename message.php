  ...
  <div class="row">
	...
	");
            ...
            <div class="col-md-6 col-sm-9">
				...
				LEFT JOIN members on message.sender_id = members.member_id where reciever_id = '$session_id' or sender_id='$session_id'");
				...
				if($row['reciever_id']==$session_id){ echo "Sent by:";  echo $row['firstname']." ".$row['lastname'];}else{
					$re=$row['reciever_id'];

					$query2 = $conn->query("select * from members WHERE member_id='$re'");
					// $query1 = $conn->query("select * from message where sender_id = '$session_id' ");
					while($row2 = $query2->fetch()){
					echo "You sent to "  ;echo $row2['firstname']." ".$row2['lastname'];
				}} ?></div>
