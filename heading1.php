    <div class="row">
      <div class="col-md-2">
		...
		<hr>
		<a class="btn btn-danger" href="change_pic.php">Change Profile Picture</a>
      </div>
		<div class="col-md-10">
			<hr>
			<div class="pull-right"><a href="edit_profile.php" class="btn btn-danger"><i class="icon-pencil"></i> Edit</a></div>
			<p>Personal Info
